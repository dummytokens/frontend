...
export default function CopyableText({ children }: Props) {
  ...
  return (
    <div
      onClick={handleCopy}
      className="cursor-pointer active:scale-95 hover:bg-gray-400/30 active:bg-gray-400/10 transition-all flex flex-row gap-4 rounded-lg py-2 px-4 bg-gray-400/20 w-fit"
    >
